...
## Configuración para el servidor 2.136.50.216
...
```env
# Base de datos
DB_HOST=2.136.50.216  # o la IP de tu servidor PostgreSQL
DB_PORT=5432
...
# Verificar salud
curl http://2.136.50.216:3006/api/health
